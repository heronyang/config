...
let g:colors_name = "heron"
hi Normal		  	guifg=Green  guibg=black
hi SpecialKey	  	guifg=Blue
hi NonText		  	gui=bold	guifg=Blue
hi Directory	  	guifg=Blue
hi ErrorMsg		  	guifg=Green  guibg=Red
hi Search		  	guifg=Green  guibg=Red
hi MoreMsg		  	gui=bold  guifg=SeaGreen
hi ModeMsg		  	gui=bold  guifg=Green	guibg=Blue
hi LineNr		  	ctermfg=Darkyellow guifg=Yellow
hi Question		  	gui=bold  guifg=Green
hi StatusLineNC		cterm=none ctermfg=grey ctermbg=darkgreen gui=NONE guifg=Green guibg=darkgreen
hi StatusLine		cterm=none ctermfg=Green ctermbg=darkgreen gui=bold	guifg=Green	guibg=darkgreen
hi VertSplit	  	gui=bold	guifg=Green	guibg=darkgreen
hi Title			gui=bold	guifg=Magenta
hi Visual			cterm=none ctermfg=Green ctermbg=darkgreen gui=NONE		guifg=Green guibg=darkgreen
...
hi Type				ctermfg=darkgreen  guifg=blue
